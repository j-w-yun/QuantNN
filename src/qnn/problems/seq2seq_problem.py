...
class Seq2SeqProblem(object):
    def __init__(self,
                 ...
                 target_name: str, target_parameters: ParametersNode, target_seqlen: int):
        ...
        self._target_seqlen = target_seqlen
    ...
    @property
    def target_seqlen(self) -> int:
        return self._target_seqlen
